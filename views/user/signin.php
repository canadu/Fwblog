...
<section class="form-container">
  <form action="<?php echo $base_url; ?>/user/authenticate" method="POST">
    ...
    <input type="password" name="password" maxlength="50" required placeholder="パスワードを入力して下さい。" class="box" oninput="this.value= this.replace(/\s/g,'')">
    <input type="submit" value="ログイン" name="submit" class="btn">
    <p>アカウント登録は<a href="<?php echo $base_url; ?>/user/sign_up">こちら</a></p>
  </form>
</section>